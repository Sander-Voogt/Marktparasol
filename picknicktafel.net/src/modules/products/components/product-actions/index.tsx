...
export default function ProductActions({
  ...
  useEffect(() => {
    // cusgroup_01KEKMNE98JN0RXSRB3YZCS359
      ...
      {authLoading ? (
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 sm:p-5">
          <div className="flex items-start gap-3 mb-3 sm:mb-4">
            ...
            <div>
              <p className="font-semibold text-amber-800">Inloggen vereist</p>
              <p className="text-sm text-amber-700">
                U dient ingelogd te zijn om prijzen te zien en producten toe te
                voegen aan uw winkelwagen.
              </p>
            </div>
          </div>
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
            <LocalizedClientLink href="/account" className="flex-1">
              <Button className="w-full h-10 sm:h-11 bg-gray-900 hover:bg-gray-800 text-white font-semibold transition-colors rounded-lg">
                Inloggen
              </Button>
            </LocalizedClientLink>
            <LocalizedClientLink href="/account" className="flex-1">
              <Button className="w-full h-10 sm:h-11 border border-gray-300 text-gray-700 hover:bg-gray-50 bg-white font-semibold transition-colors rounded-lg">
                Registreren
              </Button>
            </LocalizedClientLink>
          </div>
