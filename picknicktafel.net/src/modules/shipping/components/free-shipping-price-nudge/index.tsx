    ...
    <div className="bg-gray-50 p-3 rounded-lg border border-gray-200">
      <div className="space-y-2">
        <div className="flex justify-between text-xs text-gray-600">
          <div>
            {price.target_reached ? (
              ...
              <span className="font-medium text-gray-700">Gratis verzending</span>
            )}
          </div>
        ...
        <div className="flex justify-between gap-1">
          ...
          ></div>
          <div className="bg-gray-200 h-1.5 rounded-full w-fit flex-grow"></div>
        </div>
      </div>
    </div>
  )
...
function FreeShippingPopup({
  ...
  return (
    ...
    >
      <div>
        <Button
          className="rounded-full bg-gray-900 shadow-none outline-none border-none text-[15px] p-2"
      ...
      <div className="w-[400px] bg-gray-900 text-white p-6 rounded-xl shadow-lg">
        <div className="pb-4">
              ...
              <div>
                {price.target_reached ? (
                  <div className="flex items-center gap-1.5 text-green-400">
                    <CheckCircleSolid className="text-green-400 inline-block" />{" "}
                    Gratis verzending!
                  </div>
                ) : (
        ...
        <div className="flex gap-3">
          <LocalizedClientLink
            className="rounded-lg bg-transparent shadow-none outline-none border border-white text-[15px] py-2.5 px-4 hover:bg-white/10 transition-colors"
            href="/cart"
          >
          ...
          <LocalizedClientLink
            className="flex-grow rounded-lg bg-white text-gray-900 shadow-none outline-none border border-white text-[15px] py-2.5 px-4 text-center font-semibold hover:bg-gray-100 transition-colors"
            href="/store"
          >
            Producten bekijken
          </LocalizedClientLink>
