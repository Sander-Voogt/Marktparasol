...
export default function QuantitySelector({
  ...
  const notify = () =>
    toast("Product toegevoegd aan winkelwagen!", {
      autoClose: 2000, // 2 seconden
      hideProgressBar: true, // geen progress bar
      closeOnClick: true,
    })
  ...
  return (
    <div className="flex flex-col sm:flex-row items-stretch sm:items-end gap-2 sm:gap-4">
      <div className="flex flex-col gap-y-1 sm:gap-y-2">
        <div className="flex items-center border-2 border-gray-200 rounded-lg overflow-hidden bg-white">
          ...
          <input
            ...
            className="w-8 sm:w-12 text-center"
            min="1"
            max="99"
          />
      ...
      <Button
        ...
        className="w-full sm:flex-1 h-8 sm:h-10 px-3 py-0"
      >
        <svg
