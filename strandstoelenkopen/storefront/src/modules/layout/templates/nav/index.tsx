...
export default async function Nav() {
  ...
  const c = await getCategoryByHandle(['houten-strandstoelen'])

  console.log(categories, c.category_children)
      ...
      <header className="relative h-16 sm:h-20 mx-auto border-b border-gray-200 shadow-sm duration-200 bg-white">
        <nav className="content-container flex items-center justify-between w-full h-full px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-2 lg:gap-4">
            ...
            >
              <div className="relative w-38 lg:w-38 overflow-hidden">
                <h3 className="text-xl">Strandstoelenkopen.nl</h3>
              </div>
            </LocalizedClientLink>
          </div>
          ...
          <div className="flex-1 flex justify-center">
            ...
            >
              <div className="relative w-28 overflow-hidden">
                <h3 className="text-lg">Strandstoelenkopen.nl</h3>
              </div>
            </LocalizedClientLink>
